...
export default function Header() {
  ...
  const {pathname} = useLocation() // muestra la pagina actual
  ...
  return (
    <header className={isHome ? '' : 'bg-slate-800 h-[400px]'}
            style={
              isHome
                ? {
          ...
          onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              className="block text-white uppercase font-extrabold text-lg">
                ...
                name="ingredient"
                type="text"
                className="p-3 w-full rounded-lg border border-white bg-white focus:outline-none"
